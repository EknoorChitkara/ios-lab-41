 ...
 */
func checkMealLogSaved() -> [String: Any] {
...
let sampleMealLog: [String: Any] = [
    "breakfast": "Oatmeal",
    "lunch": "Salad",
    "dinner": "Pasta"
]

UserDefaults.standard.set(sampleMealLog, forKey: "mealLog")
let mealLog = checkMealLogSaved()
print("Meal log: \(mealLog)")
/*:
